...
from gui.gui_Qt.browser import Browser
from gui.gui_Qt.create_project import CreateProject
from gui.gui_Qt.design_studio import Design
from gui.gui_Qt.forget import Forget
from gui.gui_Qt.index import IndexPage
from gui.gui_Qt.login import Login_window
from gui.gui_Qt.new_user import NewUser
...
class DesignWin(QMainWindow, Design):
    def __init__(self):
        ...
        self.plainTextEdit.setPlainText('from python.package.actions.web_actions import *\n')
        self.tab_num = 0
